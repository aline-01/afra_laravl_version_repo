        ...
        <div class="col-12 col-lg-3 iransans">
            <div class="card border-0 mb-4 profile">
                ...
                function you_cant_chage_password() {
                    Swal.fire("این گزینه برای ادمین ها نیست");
                }
                
                </script>
                   <small class="d-block mt-3"><?php echo $this_user[0]->name; ?></small>
                </div>
               <div class="card-footer text-center d-flex justify-content-between align-items-center border-0 shadow-none py-3">
                   <a onclick="you_cant_chage_password()"  class="border-left px-2 font-sm">تغییر رمز عبور</a>
                   <a href="/admin/logout" class="font-sm"  style="margin-left: 30px " > خروج از حساب</a>
        ...
        <div class="col-12 col-lg-9 py-4">
            <div class="tab-content">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3 user-info">
                                        <div>
                                            ...
                                            <p class="font-md"><?php echo $this_user[0]->name; ?></p>
                                        </div>
                                        <div>
                                            <p class="font-sm">نام کاربری:</p>
                                            <p class="font-md"><?php echo $this_user[0]->username; ?></p>
                                        </div>
                                        <div>
                                            <p class="font-sm">سطح دسترسی:</p>
                                            <p class="font-md">مدیریت</p>
                                        </div>
                ...
                <div class="tab-pane fade " id="comments">
                    <div class="card border-0 comments">
                        <div class="card-header bg-transparent pt-0">
                         <!-- <p class="mb-0 px-2 py-1 font-md" style="background-image: linear-gradient(to right, rgba(32, 40, 119, 1), rgba(55, 46, 149, 1), rgba(83, 49, 177, 1), rgba(114, 48, 205, 1), rgba(150, 41, 230, 1)) !important;">آگهی های من</p> -->
                        </div>
                        <div class="card-body">
                            ...
                            <?php foreach($comments as $comment) { ?>
                                <tr class="" style="font-size: 12px">
                                    ...
                                    <td class="text-success"><?php echo $comment->text ?></td>
                                    <td><?php echo $comment->email; ?></td>
                                    <td>
                                        <a href="/admin/comment-opp/del/<?php echo $comment->id; ?>" class="btn btn-danger" href="#">حذف</a>
                                        <br><a href="/admin/comment-opp/accept/<?php echo $comment->id ?>" class="btn btn-success" href="#">پذیرش</a>
                                    </td>
                                </tr>
                            <?php } ?>
                                                            <!-- <tr class="" style="font-size: 12px">
