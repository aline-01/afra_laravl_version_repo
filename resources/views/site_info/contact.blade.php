...
<!-- Mirrored from appco.themetags.com/rtl/thank-you.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jan 2021 07:51:00 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-9 col-lg-7">
                    <div class="hero-content-left text-white text-center">
                        <h1 class="text-white">سپاس !</h1>

                        <p class="lead">به زودی با هم در تماس خواهیم بود. ما مشتاقانه منتظر نسخه ی نمایشی شما هستیم. اگر قبل از نسخه ی نمایشی سوالی دارید ، می توانید با ما تماس بگیرید.</p>
                        ...
                        <form action="#" method="post" class="subscribe-form text-center m-auto">
                            <div class="d-flex align-items-center">
                                ...
                                <input type="submit" class="button btn solid-btn" id="submit" value="اشتراک">
                            </div>
                        </form>
                    </div>
                </div>
